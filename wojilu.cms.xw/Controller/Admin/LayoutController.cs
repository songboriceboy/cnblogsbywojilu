...
namespace wojilu.cms.xw.Controller.Admin {
    ...
    public class LayoutController : ControllerBase {
        ...
        public LayoutController() {
            HideLayout( typeof( wojilu.cms.xw.Controller.LayoutController ) );
        }
        ...
        public override void Layout() {
            ...
            //
            set("tagList", to(new TagController().Index));
            set("addTag", to(new TagController().Add));
            
            set("showLink", to(new MainController().Index));
            //set("articleLink", to(new MainController().List));
