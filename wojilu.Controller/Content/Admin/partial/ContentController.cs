...
namespace wojilu.Web.Controller.Content.Admin {
    ...
    public partial class ContentController : ControllerBase {
        ...
        private void bindCmd() {
            ...
            set( "addRow1Url", to( new ContentController().ConfirmAddRow, 1 ) );
            set( "addRow2Url", to( new ContentController().ConfirmAddRow, 2 ) );
            set( "addRow3Url", to( new ContentController().ConfirmAddRow, 3 ) );
            set( "addRow4Url", to( new ContentController().ConfirmAddRow, 4 ) );
            set( "addRow5Url", to( new ContentController().ConfirmAddRow, 5 ) );
            set( "addRow6Url", to( new ContentController().ConfirmAddRow, 6 ) );
