...
namespace wojilu.Apps.Blog.Interface {
    ...
    public interface IBlogPostService {
        ...
        int GetCountByCategory(int appId, int categoryId);
        int GetCountByCreated(int AppId, string start, string end);
        ...
        DataPage<BlogPost> GetPageAndDraft();
        ...
        DataPage<BlogPost> GetPageByCreatedCate(int appId, int categoryId, int pageSize);
        ...
        int GetBlogCount();
        DataPage<BlogPost> Search( string key, int pageSize);
    }
}
