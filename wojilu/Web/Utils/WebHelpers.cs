...
namespace wojilu.Web.Utils {
    ...
    public class WebHelper {
        ...
        public static String GetFlash( String srcUrl, Object width, Object height ) {
            ...
            return string.Format( "<object classid=\"clsid:D27CDB6E-AE6D-11cf-96B8-444553540000\" codebase=\"http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=9,0,28,0\" width=\"{1}\" height=\"{2}\"><param name=\"movie\" value=\"{0}\" /><param name=\"quality\" value=\"high\" /><embed src=\"{0}\" quality=\"high\" pluginspage=\"http://www.adobe.com/shockwave/download/download.cgi?P1_Prod_Version=ShockwaveFlash\" type=\"application/x-shockwave-flash\" width=\"{1}\" height=\"{2}\"></embed></object>", srcUrl, width, height );
