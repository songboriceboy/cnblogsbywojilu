...
function getEmotionTable() {
    ...
    for( i= 1;i<70;i++ ) {
        ...
        trS+= '<td class="emotionItem" emId="'+ems['$'+number]+'"><img src="'+wojilu.path.js+'/editor/skin/em/'+number+'.gif" title="'+ems['$'+number]+'" /></td>';
...
function bindMbEvent(getVideoUrl, total, pubUrl ) {
    ...
    var pCount = function() { countStr(total);};
